...
public final class CasWrapperProvider20 extends BaseOAuth20Provider {
	...
	public static void main(String[] args){
		try{
			CasWrapperProvider20 provider = new CasWrapperProvider20();
			provider.getCredential(null);
		}
		catch(Exception ex){
	...
	public UserProfile getUserProfile(Token accessToken) {
		...
		return super.getUserProfile(accessToken);
	}

	@Override
	public Token getAccessToken(UserSession session, OAuthCredential credential) {
		// TODO Auto-generated method stub
		return super.getAccessToken(session, credential);
	}
